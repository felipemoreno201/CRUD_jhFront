...
type AutorFormGroupContent = {
  ...
  nombre: FormControl<IAutor['nombre']>;
  correo: FormControl<IAutor['correo']>;
  pais: FormControl<IAutor['pais']>;
};
...
export class AutorFormService {
  createAutorFormGroup(autor: AutorFormGroupInput = { id: null }): AutorFormGroup {
    ...
    return new FormGroup<AutorFormGroupContent>({
      ...
      nombre: new FormControl(autorRawValue.nombre),
      correo: new FormControl(autorRawValue.correo),
      pais: new FormControl(autorRawValue.pais),
    });
  }
